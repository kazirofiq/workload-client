    ...
    return (
      ...
      <div className="flex-1">
        ...
        <Link className="flex items-center gap-3 py-2" to="/">
          <img className="w-6 sm:w-8 md:w-12 border-2 rounded-full" 
        //   src={logo} 
          alt="" />
        ...
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="flex items-center gap-3 cursor-pointer">
            <div className="w-6 h-6 sm:w-10 sm:h-10 bg-white rounded-full overflow-hidden">
              <img src="https://i.ibb.co/Qj8XhH5/user.png" alt="" />
              {/* <img 
              src={user?.photoURL || 'https://i.ibb.co/Qj8XhH5/user.png'}
               alt='' /> */}
            </div>
          ...
          <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-[#000000] text-slate-200 rounded-box w-60 ">
            <li className='border-b-2 pb-2 mx-4 mt-3'>
              <div className="bg-transparent px-0 flex flex-col gap-0 items-center">
                ...
                <h3 className='text-center text-lg p-0'>
                  {/* {user?.displayName} */}
                  </h3>
                <p className='p-0'>
                  {/* {currentUser.role} */}
